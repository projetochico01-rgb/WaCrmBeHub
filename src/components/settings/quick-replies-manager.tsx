  ...
  return (
    <div>
      <SettingsPanelHead
        ...
        description="Respostas reutilizáveis — texto simples ou uma mensagem interativa salva — que os atendentes podem inserir na caixa de entrada."
        action={
      ...
      {loading ? (
        ...
        <p className="rounded-lg border border-dashed border-border py-10 text-center text-sm text-muted-foreground">
          Ainda não há respostas rápidas. Crie um para reutilizá-lo em conversas.
        </p>
      ) : (
            ...
            <div className="max-h-[70vh] space-y-3 overflow-y-auto">
              <div>
                ...
                <Input
                  ...
                  placeholder="por ex. Horário comercial"
              ...
              {draft.kind === "text" ? (
                <Textarea
                  ...
                  placeholder="O texto da mensagem a ser inserida"
